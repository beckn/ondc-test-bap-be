...
import org.beckn.one.sandbox.bap.protocol.shared.Util.snakeToUpperCamelCase
...
open class BecknResponseRepository<R : BecknResponseDao>(
  ...
  fun findByProviderName(id: String, providerName: String) : List<R> = findAll(and(OnSearchDao::context / ContextDao::messageId eq id, OnSearchDao::message/ OnSearchMessageDao::catalog / CatalogDao::bppDescriptor/ DescriptorDao::name  regex providerName.snakeToUpperCamelCase()))
