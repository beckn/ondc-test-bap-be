...
): AbstractPollForResponseController<ProtocolOnSelect>(responseService, contextFactory, loggingFactory, loggingService) {

  @GetMapping("protocol/response/v1/on_select")
  @ResponseBody
  fun getSelectResponses(messageId: String) = findResponses(messageId, ProtocolContext.Action.ON_SELECT)
